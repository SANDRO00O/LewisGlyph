...
const LETTERS = {
  'A': [1, 6, 8], 'B': [0, 8, 10], 'C': [3, 5], 'D': [11, 4, 9],
  'E': [3, 4, 5], 'F': [3, 4, 8], 'G': [3, 6], 'H': [0, 2, 6, 8],
  'I': [1], 'J': [2, 9], 'K': [0, 3, 5, 8], 'L': [0, 5],
  'M': [0, 2, 6, 7, 8], 'N': [2, 8], 'O': [], 'P': [8],
  'Q': [7], 'R': [3, 6, 8], 'S': [3, 9], 'T': [3, 7, 11],
  'U': [0, 2], 'V': [0, 2, 7], 'W': [0, 1, 2, 6, 8],
  'X': [3, 5, 9, 11], 'Y': [0, 2, 7], 'Z': [0, 3, 9, 6], ' ': []
};
...
function createGlyph(char, size = 80, small = false) {
  ...
  rect.setAttribute('fill', isRed ? '#B55050' : '#111');
...
document.getElementById('downloadSvg').addEventListener('click', () => {
  ...
  link.href = url;
  link.download = 'LewisGlyph_optimized.svg';
...
/* ---------------------------------------------------------
   تحسين تحميل PNG (Canvas Drawing)
   استغناء عن html2canvas لصالح الرسم المباشر
--------------------------------------------------------- */
